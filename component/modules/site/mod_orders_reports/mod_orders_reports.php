...
RLoader::registerPrefix('Modordersreports', __DIR__);

// Prepare for cache
$cacheparams = new stdClass;
$cacheparams->cachemode = 'static';
$cacheparams->class = 'ModordersreportsLibHelper';
$cacheparams->method = 'getData';
$cacheparams->methodparams = $params;

$items = JModuleHelper::moduleCache($module, $params, $cacheparams);

require JModuleHelper::getLayoutPath('mod_orders_reports', $params->get('layout', 'default'));
