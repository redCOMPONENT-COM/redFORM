						...
						<ul class="unstyled">
							<?php foreach ($item->paymentrequests as $pr): ?>
								<li>
									...
									<?php if (!$pr->paid): ?>
										<span class="hasTip" title="<?php echo JText::_('COM_REDFORM_REGISTRATION_NOT_PAID'); ?>"><i class="icon-remove"></i><?php echo $link; ?></span>
									...
									<?php else: ?>
										<span class="hasTip" title="<?php echo JText::_('COM_REDFORM_REGISTRATION_PAID'); ?>"><i class="icon-ok"></i><?php echo $link; ?></span>
									<?php endif; ?>
								</li>
							<?php endforeach; ?>
						</ul>
