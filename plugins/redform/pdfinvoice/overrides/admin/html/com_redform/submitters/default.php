...
/**
 * This is an override for pdfinvoice integration plugin
 */
										...
										<?php foreach ($invoices[$item->id][$pr->prid] as $invoice):
												...
												<div class="invoice">
													<?php echo $invoice->reference
														...
														. ' - '. ($invoice->turned ? JText::_('PLG_REDFORM_PDFINVOICE_INVOICE_TURNED').': '.$invoice->turned : JHTML::link($turnlink, JText::_('PLG_REDFORM_PDFINVOICE_TURN_INVOICE'))); ?></div>
										<?php endforeach; ?>
									<?php endif;?>
								</li>
							<?php endforeach; ?>
