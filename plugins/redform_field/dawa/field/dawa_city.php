...
/**
 * Class PlgRedform_FieldEventacymailinglistsFieldDawa_City
 *
 * @since  3.0
 */
class PlgRedform_FieldEventacymailinglistsFieldDawa_city extends RdfRfieldTextfield
{
	/**
	 * @var string
	 */
	protected $type = 'dawa_city';
