...
JPlugin::loadLanguage( 'plg_redform_payment_ideal', JPATH_ADMINISTRATOR );

class plgRedform_PaymentIdeal extends JPlugin {
 	
	public function plgRedform_PaymentIdeal(&$subject, $config = array()) 
	{
